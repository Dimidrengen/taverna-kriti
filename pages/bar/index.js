...
export default function BarPage() {
  ...
  if (orders.length === 0) return (
    <div style={styles.center}>
      ...
      <p style={{color:'#aaa',fontSize:20,marginTop:16}}>Ingen aktive drikkevareordrer</p>
    </div>
  )
  ...
  return (
    <div style={styles.page}>
      <header style={styles.header}>
        <span style={styles.headerTitle}>🍹 Bar</span>
...
const styles = {
  ...
  lineList:   {padding:'12px 16px',display:'flex',flexDirection:'column',gap:8},
