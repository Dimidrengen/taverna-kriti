...
export default function AdminPage() {
  ...
  return (
    <div style={s.page}>
      ...
      {showImport && (
        <MenuImportModal lang={lang} onClose={() => setShowImport(false)} onImported={() => fetchData()} />
      )}
          ...
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:20,flexWrap:'wrap',gap:8}}>
            ...
            <div style={{display:'flex',gap:8,flexWrap:'wrap'}}>
              <button onClick={() => setShowImport(true)}
                style={{padding:'8px 16px',background:'#7C3AED',color:'white',border:'none',borderRadius:8,fontSize:14,fontWeight:600,cursor:'pointer',fontFamily:'system-ui'}}>
                {t.importPdf}
              </button>
              {items.length > 0 && (
